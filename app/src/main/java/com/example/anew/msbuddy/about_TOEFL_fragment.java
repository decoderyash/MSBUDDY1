 ...
 */
public class about_TOEFL_fragment extends Fragment {
    @Nullable
  //  @Override
    View myview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       myview = inflater.inflate(R.layout.abouttoefl, container ,false);
        ...
        if(recyclerView!=null) {
            ...
            recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this.getActivity(), recyclerView, new ClickListener() {
                ...
                public void onClick(View view, int position) {
                    ...
                    Intent i = new Intent(context, TOEFL_ScrollingActivity.class);
    ...
    private void prepareArticleData() {
        article arti = new article("What is TOEFL");
        articleList.add(arti);

        arti = new article("How Much Is The TOEFL Exam Fee");
        articleList.add(arti);

        arti = new article("What Is The Exam Pattern Of TOEFL");
        articleList.add(arti);
        arti = new article("How Is TOEFL Evaluated");
        articleList.add(arti);
        arti = new article("TOEFL Preparation Tips");
        articleList.add(arti);
        arti = new article("How To Improve Speaking Score");
        articleList.add(arti);
        arti = new article("How To Improve Reading Score");
        articleList.add(arti);
        arti = new article("How To Improve Listening Score");
        articleList.add(arti);
